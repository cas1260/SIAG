...
Begin VB.Form FrmGrupoProd 
   Caption         =   "Cadastro de Grupo de Produto"
   ClientHeight    =   1470
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5010
   Icon            =   "FrmGrupoProd.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmGrupoProd.frx":0442
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmGrupoProd.frx":0556
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmGrupoProd.frx":066A
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmGrupoProd.frx":077E
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmGrupoProd.frx":0892
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmGrupoProd.frx":09A6
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmGrupoProd.frx":0ABA
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FrmGrupoProd"
...
5       Exit Sub
6   End If
7   Comando = "Select * from GrupoProd Where Codigo = " & txtCodigo.Text & ""
...
12  Comando = "Select * from GrupoProd Where Codigo = " & txtCodigo.Text & ""
...
4       txtCodigo.SetFocus
5   End If
6   Comando = "Select * from GrupoProd Where Codigo = " & txtCodigo.Text & ""
...
10          RsTipo.Delete
11          MsgBox "Grupo Excluir", vbExclamation, App.Title
12          Novo
